...
L_MISC_UI_OUTDATED = "Ваша версия Dark ShestakUI устарела. Вы можете скачать последнюю версию с www.wowinterface.com"
...
L_POPUP_SETTINGS_GNOSIS = "Необходимо изменить позиции элементов Gnosis."

-- Welcome message
L_WELCOME_LINE_1 = "Добро пожаловать в Dark ShestakUI "
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Сброс настроек DarkShestakUI_Config.",
