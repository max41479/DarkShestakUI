...
L_CHAT_TRADE = "Comercio"
L_CHAT_DEFENSE = "DefensaLocal"
L_CHAT_RECRUTMENT = "ReclutamientoHermandad"
L_CHAT_LFG = "BuscandoGrupo"
...
-- Popups
L_POPUP_RESETUI = "¿Estás seguro de que desea restablecer Dark ShestakUI?"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Reinicia la configuración de DarkShestakUI_Config.",
