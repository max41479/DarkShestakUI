...
function T.UploadDBM()
	if IsAddOnLoaded("DBM-Core") then
		...
		DBT_AllPersistentOptions["Default"]["DBM"].StartColorR = C.unitframe.uf_color[1]
		DBT_AllPersistentOptions["Default"]["DBM"].StartColorG = C.unitframe.uf_color[2]
		DBT_AllPersistentOptions["Default"]["DBM"].StartColorB = C.unitframe.uf_color[3]
		DBT_AllPersistentOptions["Default"]["DBM"].EndColorR = C.unitframe.uf_color[1]
		DBT_AllPersistentOptions["Default"]["DBM"].EndColorG = C.unitframe.uf_color[2]
		DBT_AllPersistentOptions["Default"]["DBM"].EndColorB = C.unitframe.uf_color[3]
