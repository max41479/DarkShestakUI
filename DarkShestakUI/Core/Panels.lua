...
toppanel.bgl:SetGradientAlpha("HORIZONTAL", 0.25, 0.25, 0.25, 0, 0.25, 0.25, 0.25, 0.1)
...
toppanel.bgr:SetGradientAlpha("HORIZONTAL", 0.25, 0.25, 0.25, 0.1, 0.25, 0.25, 0.25, 0)
...
toppanel.tcl:SetGradientAlpha("HORIZONTAL", 0.25, 0.25, 0.25, 0, 0.25, 0.25, 0.25, 1)
...
toppanel.tcr:SetGradientAlpha("HORIZONTAL", 0.25, 0.25, 0.25, 1, 0.25, 0.25, 0.25, 0)
...
toppanel.bcl:SetGradientAlpha("HORIZONTAL", 0.25, 0.25, 0.25, 0, 0.25, 0.25, 0.25, 1)
...
toppanel.bcr:SetGradientAlpha("HORIZONTAL", 0.25, 0.25, 0.25, 1, 0.25, 0.25, 0.25, 0)
