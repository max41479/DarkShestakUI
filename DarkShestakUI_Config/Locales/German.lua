...
L_GUI_RESET_CHAR = "Bist du sicher, dass du die Charaktereinstellungen für Dark ShestakUI zurücksetzen willst?"
L_GUI_RESET_ALL = "Bist du sicher, dass du alle Einstellungen von Dark ShestakUI zurücksetzen willst?"
