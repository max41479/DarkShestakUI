...
L_GUI_REMINDER_SOLO_ENABLE = "自身Buff缺失,图示提示"
L_GUI_REMINDER_SOLO_SOUND = "自身Buff缺失,声音提示"
L_GUI_REMINDER_SOLO_SIZE = "自身Buff提示图示大小"
L_GUI_REMINDER_RAID_ENABLE = "团队Buff缺失,图示提示"
L_GUI_REMINDER_RAID_ALWAYS = "总是显示Buff提示"
L_GUI_REMINDER_RAID_SIZE = "团队Buff提示图示大小"
L_GUI_REMINDER_RAID_ALPHA = "当团队Buff存在时图示透明度"
...
L_GUI_NAMEPLATE_SHOW_DEBUFFS = "DeBuff图示(需要关闭'名字缩写')"
...
-- Auras/Buffs/Debuffs
L_GUI_AURA_PLAYER_BUFF_SIZE = "玩家Buff图示大小"
...
L_GUI_AURA_FOT_DEBUFFS = "焦点目标显示DeBuff"
...
L_GUI_AURA_CAST_BY = "鼠标提示中,显示Buff/DeBuff提供者"
