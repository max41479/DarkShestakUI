...
L_GUI_RESET_CHAR = "Вы уверены, что хотите сбросить все настройки Dark ShestakUI для этого персонажа?"
L_GUI_RESET_ALL = "Вы уверены, что хотите сбросить все настройки Dark ShestakUI?"
...
L_GUI_SKINS_COLOR_THEME = "Цветовая схема"
L_GUI_SKINS_BLIZZARD = "Стилизация элементов интерфейса Blizzard"
L_GUI_SKINS_SHADOW = "Тень на окнах"
L_GUI_SKINS_MINIMAP_BUTTONS = "Стилизация кнопок модификаций у миникарты"
L_GUI_SKINS_MINIMAP_BUTTONS_MOUSEOVER = "Кнопки модификаций по наведению курсора"
...
L_GUI_SKINS_GNOSIS = "Стилизация Gnosis"
...
L_GUI_CHAT_TOOL_BAR = "ToolBar - переключение окна лута/дамагметра"
L_GUI_CHAT_TOOL_BAR_MOUSEOVER =  "ToolBar по наведению курсора"
